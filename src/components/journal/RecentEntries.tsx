...
export const RecentEntries = ({
  ...
  selectedEntryId?: string | number
}) => {
  if (entries.length === 0) {
    return (
      <div className="bg-vintage-paper border border-vintage-border rounded-2xl p-6 shadow-vintage">
        <h3 className="font-display text-lg text-vintage-ink mb-4">Recent Entries</h3>
  ...
  return (
    <div className="bg-vintage-paper border border-vintage-border rounded-2xl p-2 sm:p-2 shadow-vintage w-[75%] ml-[50px]">
      <h3 className="font-display text-lg text-vintage-ink mb-4 px-1">Recent Entries</h3>
