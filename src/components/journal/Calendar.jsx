...
export const Calendar = ({ entryDates = [], onDateSelect, selectedDate }) => {
  ...
  const renderCells = () => {
    ...
    // 👉 FORCE 6 ROWS ALWAYS (42 days = no resizing ever)
    const totalDays = 42
      ...
      days.push(
        <div
          ...
          className={`
            ...
            ${isSelected
              ? 'bg-vintage-brown text-vintage-paper font-semibold shadow-md scale-105'
              : ''
            }
